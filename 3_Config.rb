...
class Config
    ...
    def initialize()
        ...
        db_file_path3 = "/home/ban/.local/share/QuiteRss/QuiteRss/feeds.db"
    ...
    # ホームページカテゴリー
    @home_category = [["フェラ","fella"],["お掃除フェラ","fella2"],["イキ","iki"],["３Ｐ","3P"],["AV女優","AV"],["おしっこ","osikko"],["おっぱい","Boobs"],
                     ...
                     ["孕ませ","haramase"],["巨乳","melon"],["潮吹き","female_ejaculation"],["精子","cream"],["触手","tentacle"],["顔射","Cum_Shot"],["脇","waki"],
                     ["深田えいみ","eimi"],["美谷朱里","mitani"],["枢木あおい","aoi"],["波多野結衣","namita"],["篠田ゆう","you"],["蓮実クレア","kurea"],["稲場るか","ruka"],["伊藤舞雪","eimi"],["倉多まお","eimi"],
                     ["河合あすな","asuna"],["渚みつき","mituki"],["橋本ありな","arina"],["三上悠亜","mikami"],["葵つかさ","tukasa"],["根尾あかり","akari"],["星奈あい","ai"],["天使もえ","tensimoe"],["奥田咲","saki"],
                     ["羽咲みはる","miharu"],["跡美しゅり","syuri"],["筧ジュン","jyun"],["君島みお","mio"],["夢乃あいか","aika"],["大槻ひびき","hibiki"],["永瀬ゆい","yui"],["坂道みる","miru"],["麻里梨夏","asari"],["あおいれな","aoirena"],
                     ["高橋しょう子","syouko"],["今井夏帆","imai"],["桃乃木かな","kana"],["凛音とうか","touka"],["鈴村あいり","airi"],["架乃ゆら","yura"],["あべみかこ","abemikako"],["椎名そら","sora"],["ひなたまりん","hinatamarinn"],["八乃つばさ","tubasa"],["高杉麻里","takasugi"],["みひな","mihina"],
                     ["紗倉まな","mana"],["涼森れむ","remu"],["上原亜衣","uehara"],["坂道みる","miru"]
    ...
    # htmlの作成先
    #@www_html_out_path = "/home/ban/QuiteRSS/www/"
